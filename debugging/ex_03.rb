...
#     exactly three odd numbers. Additionally, the numbers in the series must
#     sum to 47.
...
def valid_series?(nums)
  ...
  odd_count = nums.count { |n| n.odd? }
  odd_count == 3 ? true : false     # this was assigning 3 to odd_count (=)
end                                 # rather than checking for equality (==)
